			...
			<ul class="navbar-nav mr-right">
				...
				<li class="nav-item dropdown no-arrow"><a
					...
					<div
						...
						<a class="dropdown-item" href="#" data-toggle="modal"
						...
						</a> <a class="dropdown-item" href="MyPost_Page.jsp"> <i
							...
							Post List
						</a> <a class="dropdown-item" href="Postlist.jsp"> <i
	...
	<div class="container">
		...
		<div class="row ">
			<div class="col-md-12 col-sm-12 col-12 " style="text-align: center;">
				<h2 class="font-weight-light">My PostList</h2>
			</div>
		...
		<div class="row">
			...
			<div class=" col-lg-6 col-xl-6 col-md-6 col-sm-12 col-12 mb-4">
				<div class="card shadow mb-4">
					...
					<!-- Card Body -->
					<a href="#" style="text-decoration: none; font-weight: lighter;"><div
							class="card-body text-left"
							style="max-height: 250px; height: 200px;"><%=pl.getPldesc()%></div></a>
				</div>
			</div>
